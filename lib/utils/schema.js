...
var SchemaUtil = /*#__PURE__*/function () {
  ...
  _createClass(SchemaUtil, [{
    ...
    key: "getPureSchema",
    value: function getPureSchema(schema) {
      if ((0, _tool._is)(schema, ["array", "object"])) {
        var node = Array.isArray(schema) ? [] : {};
    ...
    value: function deepSearchById(node, id) {
      if ((0, _tool._is)(node, ["array", "object"])) {
        ...
        for (var _i4 = 0, _Object$entries4 = Object.entries(node); _i4 < _Object$entries4.length; _i4++) {

...
var _widgetProperty = require("./widget-property");
...
var Widget = /*#__PURE__*/function (_React$Component) {
  ...
  function Widget(props, context) {
    ...
    _this.widgetProperty = new _widgetProperty.WidgetProperty();

    _this.widgetProperty.updateProperty(props, context, _this.update);
...
Widget.contextType = _formProperty.SFContext;
...
function useWidget(props) {
  ...
  var context = _react.default.useContext(_formProperty.SFContext);

  var widgetProperty = _react.default.useRef(new _widgetProperty.WidgetProperty()).current;

  widgetProperty.updateProperty(props, context, function () {
